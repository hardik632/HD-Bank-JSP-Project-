...
<body>
	...
	<table style="background: #FFFFFF; margin: 0 auto;">
		...
		if(status==true){
			...
			PreparedStatement ps1=con.prepareStatement("Select * from fd where accountno=?");
            ps1.setInt(1,accountno);
			ResultSet rs1=ps1.executeQuery();
			
			out.print("<table align='left' cellspacing='5' cellpadding='5' border=1px>");
			out.print("<tr><th>ACCOUNT NO</th><th>USERNAME</th><th>AMOUNT</th><th>DATE OF ISSUE</th><th>TENURE</th></tr>");
			while(rs1.next()){
