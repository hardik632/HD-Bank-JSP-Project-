...
<body>
	<div id="top_links">
		...
		if(status==true){
			...
			PreparedStatement ps2=con1.prepareStatement("update NEWACCOUNT set amount=? where accountno='"+accountno+"'");
			...
			request.setAttribute("balance","There is a credit in your Balance,Updated Balance: ");	
			%>
