...
<body>
 <div id="top_links">
        ...
        <marquee style="background-color:white;">"No carelessness until there is a cure" </marquee>

        <div id="header">
            <A href="index.html"><IMG SRC="pictures/12.png" height="50px" width="50px"></IMG></A>
                                        ...
                                        <table >
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input class="button button3" type="reset" value="Clear" />
